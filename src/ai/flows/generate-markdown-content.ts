...
const generateMarkdownContentFlow = ai.defineFlow(
  ...
  async input => {
    ...
    // This is a temporary solution to handle both markdown and HTML links.
    // It replaces the old markdown `###` links with HTML `<h3>` links.
