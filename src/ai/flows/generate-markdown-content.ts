...
const TEMPLATES = [
  ...
  `
    ...
    <p>✅ 实时监测所有链接状态，确保每条链接均可正常访问，杜绝失效情况。</p>
    <p>📱 支持各种设备，包括手机、平板和电脑，跨平台无缝体验。</p>
    <p>🙈 无需注册，无需登录，完全免费，保护用户隐私安全。</p>
    <p>🚫 提供简洁清爽的界面，无任何弹窗和广告打扰。</p>
    <p><strong>🤔 遇到访问问题怎么办？</strong></p>
    <p>🔁 首先尝试刷新页面或关闭浏览器缓存，清除旧数据。</p>
    <p>🌐 尝试切换不同浏览器访问，比如 Chrome、Firefox 或 Edge。</p>
    <p>🕵️ 使用浏览器隐身模式，避免浏览器扩展或缓存干扰访问。</p>
    <p>🔒 如果网络环境有限制，建议使用 VPN 或代理服务，突破地理屏蔽。</p>
    <p>📶 确认您的网络连接正常，必要时切换至数据流量或其他网络环境。</p>
  ...
  `
    ...
    <p>🛡️ 多线路保障，确保任一线路出现故障时能迅速切换，不影响您的观看体验。</p>
    <p>🚀 采用先进的服务器集群技术，极大提升访问速度和稳定性。</p>
    <p>🔄 定期更新内容，保证资源丰富多样，满足不同用户需求。</p>
    <p>🛑 严格无广告政策，杜绝一切骚扰弹窗和弹广告，专注提升用户体验。</p>
    <p>🤫 完全匿名访问，绝不收集任何个人信息，保护您的隐私安全。</p>
    <p><strong>💡 使用技巧：</strong></p>
    <p>📑 请尽量收藏多个链接，预防主链接偶尔因维护或封锁而暂时无法访问。</p>
    <p>🧹 遇到无法访问或加载缓慢时，可尝试清理浏览器缓存或切换网络环境。</p>
    <p>✨ 推荐使用最新版主流浏览器，如 Chrome、Firefox 以获得最佳性能。</p>
    <p>🌍 若您身处网络受限区域，建议配合 VPN 使用，保障访问畅通。</p>
    <p><strong>📞 用户支持：</strong></p>
  ...
  `
    ...
    <p>📱 移动设备推荐使用 Chrome 或 Safari 浏览器，获得最佳兼容性和体验。</p>
    <p>📶 如果您在 WiFi 网络下遇到访问障碍，建议切换到 4G/5G 移动网络或使用 VPN。</p>
    <p>🕵️‍♂️ 浏览时开启无痕/隐身模式，避免浏览器缓存对页面加载造成影响。</p>
    <p>🧹 遇到页面显示异常或链接无法访问，尝试清理浏览器缓存和 Cookie。</p>
    <p><strong>⚙️ 技术保障：</strong></p>
    <p>✅ 本导航页面为唯一官方入口，所有链接均经过严格检测，杜绝失效和安全隐患。</p>
    <p>🚫 绝无任何弹窗、广告或恶意插件，确保用户安全无忧。</p>
    <p>🔄 我们每日对链接状态进行检测并及时更新，保障链接实时有效。</p>
    <p>💬 任何访问问题均可通过官方渠道反馈，获得快速专业支持。</p>
    <p><strong>❤️ 用户隐私：</strong></p>
  ...
  `
    ...
    <p>🧼 清爽界面，告别广告与干扰。</p>
    <p>🔒 安全访问，全面保护您的隐私信息。</p>
    <p><strong>🛠️ 问题解决方案：</strong></p>
    <p>❓ 页面打不开？请先尝试刷新并清理缓存。</p>
    <p>🔗 链接失效？使用备用入口即可。</p>
    <p>🌍 网络受限？请尝试使用 VPN。</p>
    <p>🖥️ 页面异常？切换浏览器或开启隐身模式。</p>
  ...
  `
    ...
    <p>🕵️ 专业团队实时检测，确保入口可用。</p>
    <p>📱 全平台适配，畅享无缝体验。</p>
    <p>⚡ 高速线路保障，访问更快更稳定。</p>
    <p>💰 完全免费，无需注册即可访问。</p>
    <p>🔒 严格隐私保护，无痕浏览更安心。</p>
    <p><strong>⚙️ 常见问题应对：</strong></p>
    <p>🔄 访问异常时，请刷新或切换浏览器。</p>
    <p>🌐 网络不通畅时，尝试更换网络或启用 VPN。</p>
    <p>🛠️ 入口临时无法使用时，请使用备用地址。</p>
  ...
  `
    ...
    <p>❓ 链接无法打开？尝试刷新或切换备用地址。</p>
    <p>🐢 页面卡顿？请清理浏览器缓存或切换网络。</p>
    <p>🔒 受限网络？建议使用 VPN 工具加速访问。</p>
  ...
  `
    ...
    <p>❓ 打不开怎么办？请刷新或切换备用入口。</p>
    <p>🐢 访问缓慢怎么办？建议切换网络或开启 VPN。</p>
    <p>🖥️ 页面异常怎么办？尝试隐身模式或清理缓存。</p>
    <p><strong>💡 温馨提示：</strong></p>
  ...
  `
    ...
    <p>🔖 收藏此页面，确保每次都能找到最新地址。</p>
    <p>🌐 使用主流浏览器，避免兼容性问题。</p>
    <p>🌍 遇到网络受限，可搭配 VPN 使用。</p>
  ...
  `
    ...
    <h1><a style="color: black; text-decoration: none;" href="{domain}">👉👉立即进入👈👈</a></h1>
    <p><strong>✨ 我们承诺：</strong></p>
    <p>✅ 所有入口均经过严格检测，保证安全稳定。</p>
    <p>🔄 实时更新，避免访问中断。</p>
    <p>🚫 界面简洁，杜绝广告干扰。</p>
    <p>🤫 完全匿名，最大限度保护用户隐私。</p>
    <p><strong>💡 常见使用建议：</strong></p>
    <p>📑 建议收藏多个入口地址备用。</p>
    <p>🧹 访问出现问题时，请切换浏览器或清理缓存。</p>
    <p>🌍 若所在地区限制访问，请配合 VPN 使用。</p>
